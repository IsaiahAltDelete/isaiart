...
Use `pixelforge` at `C:\Users\Dizzy\Documents\Claude\tools\pixelforge\pxforge.py`.
Pure Python stdlib — no install, no Pillow.
...
Full reference and recipes: `C:\Users\Dizzy\Documents\Claude\tools\pixelforge\README.md`
